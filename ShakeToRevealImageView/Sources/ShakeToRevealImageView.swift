...
@IBDesignable
class ShakeToRevealImageView: UIImageView {
    ...
    @IBInspectable var overlayColor: UIColor = UIColor.black.withAlphaComponent(0.8) {
        didSet {
            overlayView.backgroundColor = overlayColor
        }
    }

    @IBInspectable var feedbackStyle: UIImpactFeedbackGenerator.FeedbackStyle = .light {
        didSet {
